...
class SaeTOAuthV2Model{
     ...
     *      [appkey] => 4215835456
     *      [scope] => 
     *      [create_at] => 1380867069
     *      [expire_in] => 131872
     *  )) 
     */
    public function getTokenExpiredSecond($access_token){
        
        $params = array();
        $params['access_token'] = $access_token;
        $response = $this->oAuthRequest('https://api.weibo.com/oauth2/get_token_info', 'POST', $params); 
